...
import { submitEmailCode } from "../../store/actions/users";
import { signUpError } from "../../store/actions/users";
...
class EmailCode extends Component {
    ...
    codeSubmitHandler = () => {
        //check for blanks
        if (this.state.email_code.trim() === "") {
            return;
        }

        Keyboard.dismiss();

        this.props.onSubmitEmailCode(
            this.state.email_code.trim()
        );
    };
...
const mapDispatchToProps = dispatch => ({
    ...
    onSubmitEmailCode: email_code => dispatch(submitEmailCode(email_code)),
